...
public class EscapeSequences {
    ...
    public static final String SET_TEXT_COLOR_RED = SET_TEXT_COLOR + "131m";
    ...
    public static final String SET_TEXT_COLOR_BLUE = SET_TEXT_COLOR + "67m";
    ...
    public static final String SET_BG_COLOR_GREEN = SET_BG_COLOR + "106m";
    public static final String SET_BG_COLOR_DARK_GREEN = SET_BG_COLOR + "64m";
    public static final String SET_BG_COLOR_YELLOW = SET_BG_COLOR + "178m";
    public static final String SET_BG_COLOR_BLUE = SET_BG_COLOR + "12m";
    public static final String SET_BG_COLOR_MAGENTA = SET_BG_COLOR + "5m";
    public static final String SET_BG_COLOR_WHITE = SET_BG_COLOR + "230m";
